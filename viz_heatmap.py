...
class HeatmapMixin:
    ...
    def _prepare_heatmap_display(self, heat, smooth=True):
        ...
        Pipeline:
          1. Optional light Gaussian smoothing (σ≈1.5) to remove single-cell
          ...
          3. Mild gamma (γ=0.7) — much lighter than the previous γ=0.32 —
        ...
        # collapsing the dynamic range. γ=1.0 means linear; γ<1 brightens.
